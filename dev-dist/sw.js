...
define(['./workbox-8db671c1'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    "url": "index.html",
    "revision": "0.di6sonauq6c"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/^https:\/\/api\.bidwinners\.net\/.*/i, new workbox.NetworkFirst({
    ...
    plugins: [new workbox.ExpirationPlugin({
      ...
      statuses: [0, 200]
    }), new workbox.BackgroundSyncPlugin("chatbw-api-queue", {
